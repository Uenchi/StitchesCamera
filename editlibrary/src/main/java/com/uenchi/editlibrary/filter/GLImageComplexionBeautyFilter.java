...
public class GLImageComplexionBeautyFilter extends GlFilter {
    ...
    public void initProgram() {
        super.initProgram();
        grayTextureLoc = GLES30.glGetUniformLocation(program, "grayTexture");
        lookupTextureLoc = GLES30.glGetUniformLocation(program, "lookupTexture");
        levelRangeInvLoc = GLES30.glGetUniformLocation(program, "levelRangeInv");
        levelBlackLoc = GLES30.glGetUniformLocation(program, "levelBlack");
        alphaLoc = GLES30.glGetUniformLocation(program, "alpha");
