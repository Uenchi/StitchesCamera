...
public class GlItchFilter extends GlFilter {
    ...
    public void initProgram() {
        super.initProgram();
        mScanLineJitterLocation = glGetUniformLocation(program, "uScanLineJitter");
        mColorDriftLocation = glGetUniformLocation(program, "uColorDrift");
        mGlobalTimeLocation = glGetUniformLocation(program, "uGlobalTime");
    }
