...
//    private EGLSurface eglSurface = EGL14.EGL_NO_SURFACE;
     ...
     */
    public DecoderOutputSurface(GlFilterList filterList) {
...
//                    Log.d(TAG, "scale[0] = " + scale[0] + " scale[1] = " + scale[1]);
            ...
            case TEST:
//                Matrix.translateM(MVPMatrix, 0, -0.29f, -0.28f, 0f);
                if (fillModeCustomItem != null){
                    Matrix.scaleM(MVPMatrix, 0, fillModeCustomItem.getScaleX() * scaleDirectionX,
                            fillModeCustomItem.getScaleY() * scaleDirectionY, 1);
                }
        ...
        if (filterList != null) {
            ...
            filterList.draw(glFilterFrameBuffer.getTexName(), fbo, presentationTimeUs);
        }
    }
