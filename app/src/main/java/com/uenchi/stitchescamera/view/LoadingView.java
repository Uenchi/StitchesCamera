package com.uenchi.stitchescamera.view;
...
public class LoadingView extends View {
    ...
    private static final int MIX_COLOR = Color.TRANSPARENT;
    ...
    private void initDraw() {
        ...
        mixPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
    ...
    private void initAnim() {
        ...
        anim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (!isAnimCanceled && EmptyUtils.isNotEmpty(anim)) {
                    anim.start();
                }
            }
        });
    ...
    public void setOrientation(boolean isL2R) {
        isLtr = isL2R;
    }
